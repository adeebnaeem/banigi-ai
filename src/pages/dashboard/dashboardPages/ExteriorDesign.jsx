          ...
          <div className="dash_ExteriorDesignFirst">
            ...
            <div>
              ...
              <select name="" id="" className="custom-select">
                ...
                <option value="">Fill The Exterior</option>
              </select>
            </div>
            <div>
          ...
          <div className="ExteriorDesignFileDiv">
            <div className="ExteriorDesignFile">
              <span>
                ...
                {selectedName ||
                  "Tap to upload Exterior image Or Drag Image here direclty"}
              </span>
              <input type="file" name="" id="" onChange={handleFileChange} />
            </div>

            <div className="ExteriorDesignFileImg">Generated Image</div>
          </div>
